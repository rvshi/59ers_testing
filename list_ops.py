...
def get_sum(input_list):
    ...
    # except TypeError:
    #     logging.warning("Input is the wrong type, should be list of integers")
    # except ValueError:
    #     logging.warning("Input values out of range, should be be between -9,000 and 9,000")
    #
...
def get_max_diff(input_list):
    ...
    #     logging.warning("Input is the wrong type, should be list of integers")
    # except ValueError:
    #     logging.warning("Input values out of range, should be between -9,000 and 9,000")
